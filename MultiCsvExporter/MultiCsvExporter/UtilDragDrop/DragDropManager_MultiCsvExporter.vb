Public Class DragDropManager_MultiCsvExporter
    ...
    Sub New(logger As AppLogger, form As FormMultiCsvExporter)
        ...
        '// set DragDrop
        'src path
        _dragAndDropControl_InputDir = New DragAndDropControl(_logger, form.TextBox_SrcFilePath)
        ...
        'src path
        _dragAndDropControl_DesttDir = New DragAndDropControl(_logger, form.TextBox_DestFilePath)
        '_dragAndDropOnControl.AddRecieveControl(_groupBox)  '別コントロールにもイベントを追加
